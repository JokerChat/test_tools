...
class HelloSql(object):
    ...
    def __init__(self, **kwargs):
        logging.info("mysql_config:{}".format(str(kwargs)))
    ...
    def connect(self):
        try:
            ...
            logging.info("数据库连接失败，开始重连:{}".format(e))
            time.sleep(5)
            conn = pymysql.connect(charset='utf8', **self.mysql_config)
            return conn
    ...
    def insert_one(self, conn, sql, value=None):
        try:
            ...
            logging.info("insert_one出错:{}".format(e))
            return False
    ...
    def update(self, conn, sql, value=None):
        try:
            ...
            logging.info("update出错:{}".format(e))
            return False
    ...
    def delete(self, conn, sql, value=None):
        try:
            ...
            logging.info("delete出错:{}".format(e))
            return False
    ...
    def execute(conn, sql, value=None):
        try:
            ...
            logging.info('execute出错:{}'.format(e))
    ...
    def sql_row_to_dict(cursor=None, row=None):
        ...
        try:
            ...
            logging.error('sql_row_to_dict出错:{}'.format(e))
    ...
    def dict_datetime_obj_to_str(result_dict):
        ...
        try:
            ...
            logging.info("dict_datetime_obj_to_str出错:{}".format(e))
