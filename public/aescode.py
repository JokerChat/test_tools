...
from public.api_common import api_aes_key,api_aes_iv
...
class AES_CBC:
    ...
    def encrypt_oracle(self,  text):
        # 初始化加密器
        aes = AES.new(self.add_to_16(api_aes_key), AES.MODE_CBC, self.add_to_16(api_aes_iv))
        bs = AES.block_size
...
if __name__ == '__main__':
    ...
    # 解密
    dec_text = aes.decrypt_oralce('CIDtcy7H0suSWQC49L8bSQ==')
    print(enc_text)
    print(dec_text)
